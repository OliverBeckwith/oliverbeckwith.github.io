...
export const Email = () => {
  return (
    <ContactIcon xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 330.001 330.001" xmlSpace="preserve">
      <g id="XMLID_348_">
